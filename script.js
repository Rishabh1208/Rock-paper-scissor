...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
  ...
  humandiv.innerHTML =
    ...
    "' height=150 width=150 style='box-shadow: 2px 8px 50px rgba(37,50,233,1);'>";
  botdiv.innerHTML =
    "<img src='" +
    ImageDatabase[botImageChoice] +
    "' height=150 width=150 style='box-shadow: 2px 8px 50px rgba(243,38,24,1);'>";
  messagediv.innerHTML =
    "<h1 style='color: " +
    finalMessage["color"] +
    "; font-soxe:60px; padding:30px;'>" +
